...
#Aggregate Insurance Year & Quarter
...
#Aggregation User Plot Quarter & Year
...
#sidebar section1
with st.sidebar:
    select= option_menu("Main Menu",["Home", "Data Visualization and Exploration", "Top 10 Questions"])
...
if select == "Home":
    ...
    with col2:
        st.video("https://youtu.be/6V7WbsZ9bz4")
       

    col3,col4= st.columns(2)
    
    with col3:
        st.video("https://youtu.be/zGlDkrNxDU8")
...
if select == "Data Visualization and Exploration":
    ...
    with tab2:
        ...
        if method_map == "Map Insurance Analysis":
            ...
            col1,col2= st.columns(2)
            with col1:
                years_m2= st.slider("**Select the Year_mt**", Map_transaction["Years"].min(), Map_transaction["Years"].max(),Map_transaction["Years"].min())
